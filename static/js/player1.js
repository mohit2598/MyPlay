...
$(document).ready(function () {
    ...
    $(vid).attr("src", $("li.link:first").data('link'));

    // addClass playing to first video link
    $("li.link:first").addClass("playing");
    ...
    $("li.link").on("click", function (event) {
        ...
        if ($("li.link:first").hasClass("playing")) {
        ...
        if ($("li.link:last").hasClass("playing")) {
    ...
    $(".prevvid").click(function () {
        ...
        var x = $(".playing").prev().data('link');
        console.log(x);
        $(vid).attr("src", $(".playing").prev().data('link'));
        vid[0].play();
    ...
    $(".nextvid").click(function () {
        $(vid).attr("src", $(".playing").next().data("link"));
        vid[0].play();
    ...
    document.onkeydown = function (event) {
        ...
        switch (event.keyCode) {
            case 38: event.preventDefault();
                audio_vol = vid[0].volume;
                console.log('audio_vol '+ audio_vol);
                if (audio_vol != 1) {
                    try {
                        vid[0].volume = audio_vol + 0.02;
                    }
                    catch (err) {
                        vid[0].volume = 1;
                    }
            ...
            case 37: event.preventDefault();
                ...
                vid_currentTime = vid[0].currentTime;
                vid[0].currentTime = vid_currentTime - 5;
                break;
